...
class Race
{
     ...
     * @Assert\File(maxSize = "100K",mimeTypes={"text/csv","text/plain", "application/csv", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}
    )
     * @var File|null
     */
    private $rankingFile;
