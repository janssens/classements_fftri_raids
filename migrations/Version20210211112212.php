 ...
 */
final class Version20210211112212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE race ADD coefficient INT NOT NULL DEFAULT 1');

        $this->addSql('DROP VIEW view_official_ranking');

        $this->addSql('CREATE VIEW view_official_ranking AS 
            SELECT CONCAT(LPAD(athlete_id,6,"0"),LPAD(championship.id,3,"0"),team.gender) as id,athlete_id,sum(value*race.coefficient) as points,team.gender as category,championship.id as championship_id
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE race DROP coefficient');
